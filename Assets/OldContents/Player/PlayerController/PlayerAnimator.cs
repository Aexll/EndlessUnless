...
public class PlayerAnimator : MonoBehaviour {
        ...
        void Update() {
            ...
            // Flip the sprite
            if (_player.InputThisFrame.HorisontalAxis != 0) transform.localScale = new Vector3(_player.InputThisFrame.HorisontalAxis > 0 ? 1 : -1, 1, 1);

            // Lean while running
            var targetRotVector = new Vector3(0, 0, Mathf.Lerp(-_maxTilt, _maxTilt, Mathf.InverseLerp(-1, 1, _player.InputThisFrame.HorisontalAxis)));
            ...
            _anim.SetFloat(IdleSpeedKey, Mathf.Lerp(1, _maxIdleSpeed, Mathf.Abs(_player.InputThisFrame.HorisontalAxis)));
